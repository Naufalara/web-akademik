        ...
        <div class="row d-flex dashboard">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div>
                            <h2 class="card-title">IRS Semester {{ $semester }} : </h2>
                        </div>
                        <div>
                            <label class="card-title">Nilai IP : </label>
                            <label>{{ $irsDetail->nilai_ip }}</label>
                        </div>
                        <div>
                            <label class="card-title">Data Scan IRS : </label>
                            <label>{{ $irsDetail->scan_irs }}</label>
                        </div>
                    </div>
                </div>
            </div>
